...
if __name__ == "__main__":    
    ...
    result_df = open(f"{save_path}/n_trials{num_trials}.csv", "w")
    ...
    for t in range(num_trials):
        ...
        acc, best_1, best_2, prob, label, pred = train_test(data_folder, view_list, num_class, lr_e_pretrain, lr_e, lr_c, num_epoch_pretrain, num_epoch)
